...
class PWAEnumerationSet(object):
    swagger_types = {
        'description': 'str',
        'id': 'str',
        'links': 'PWAEnumerationSetLinks',
        'name': 'str',
        'path': 'str',
    ...
    def __init__(self, description=None, id=None, links=None, name=None, path=None, serialize_description=None, web_exception=None, web_id=None):
    ...
    def __eq__(self, other):
        if not isinstance(other, PWAEnumerationSet):
            return False
