...
class PWAPoint(object):
    ...
    def __init__(self, descriptor=None, digital_set_name=None, display_digits=None, engineering_units=None, future=None, id=None, links=None, name=None, path=None, point_class=None, point_type=None, span=None, step=None, web_exception=None, web_id=None, zero=None):
    ...
    def __eq__(self, other):
        if not isinstance(other, PWAPoint):
            return False
