...
class PWANotificationRuleTemplate(object):
    swagger_types = {
    ...
    def __init__(self, category_names=None, criteria=None, description=None, id=None, multi_trigger_event_option=None, name=None, nonrepetition_interval=None, path=None, resend_interval=None, status=None, template_name=None, web_exception=None, web_id=None):
    ...
    def __eq__(self, other):
        if not isinstance(other, PWANotificationRuleTemplate):
            return False
