...
class PWAStreamValues(object):
    swagger_types = {
        'items': 'list[PWATimedValue]',
        'links': 'PWAStreamValuesLinks',
        'name': 'str',
        'path': 'str',
    ...
    def __init__(self, items=None, links=None, name=None, path=None, units_abbreviation=None, web_exception=None, web_id=None):
    ...
    def __eq__(self, other):
        if not isinstance(other, PWAStreamValues):
            return False
