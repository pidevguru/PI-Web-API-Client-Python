...
class PWASecurityRights(object):
    swagger_types = {
        'can_annotate': 'bool',
        'can_delete': 'bool',
        'can_execute': 'bool',
    ...
    def __init__(self, can_annotate=None, can_delete=None, can_execute=None, can_read=None, can_read_data=None, can_subscribe=None, can_subscribe_others=None, can_write=None, can_write_data=None, has_admin=None, links=None, owner_web_id=None, rights=None, security_item=None, user_identity=None, web_exception=None):
    ...
    def __eq__(self, other):
        if not isinstance(other, PWASecurityRights):
            return False
