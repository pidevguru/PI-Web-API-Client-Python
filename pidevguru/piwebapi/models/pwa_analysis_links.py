...
class PWAAnalysisLinks(object):
    ...
    def __init__(self, analysis_rule=None, analysis_rule_plug_in=None, categories=None, database=None, security=None, security_entries=None, target=None, template=None, time_rule=None, time_rule_plug_in=None):
    ...
    def __eq__(self, other):
        if not isinstance(other, PWAAnalysisLinks):
            return False
