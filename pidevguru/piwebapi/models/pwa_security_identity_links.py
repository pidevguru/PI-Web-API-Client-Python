...
class PWASecurityIdentityLinks(object):
    swagger_types = {
        'asset_server': 'str',
        'security': 'str',
    ...
    def __init__(self, asset_server=None, security=None, security_entries=None, security_mappings=None):
    ...
    def __eq__(self, other):
        if not isinstance(other, PWASecurityIdentityLinks):
            return False
