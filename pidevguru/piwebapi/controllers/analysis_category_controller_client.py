...
class AnalysisCategoryControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysiscategories',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        response_type='PWAAnalysisCategory',
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/analysiscategories/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_with_http(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysiscategories/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysiscategories/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_security_entry_with_http(self, name, web_id, apply_to_children=None, **kwargs):
        ...
        return self.api_client.call_api('/analysiscategories/{webId}/securityentries/{name}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
