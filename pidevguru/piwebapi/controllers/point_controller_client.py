...
class PointControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/points',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_multiple_with_http(self, as_parallel=None, include_mode=None, path=None, selected_fields=None, web_id=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/points/multiple',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsItemPoint',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/points/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, point_d_t_o, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, point_d_t_o, **kwargs)
        else:
            data = self.update_with_http(web_id, point_d_t_o, **kwargs)
            return data

    def update_with_http(self, web_id, point_d_t_o, **kwargs):
        all_params = list(['web_id', 'point_d_t_o'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_attributes(self, web_id, name=None, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_attributes_with_http(web_id, name, name_filter, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_attributes_with_http(web_id, name, name_filter, selected_fields, web_id_type, **kwargs)
            return data

    def get_attributes_with_http(self, web_id, name=None, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'name', 'name_filter', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/points/{webId}/attributes',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsPointAttribute',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_attribute_by_name(self, name, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_attribute_by_name_with_http(name, web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_attribute_by_name_with_http(name, web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_attribute_by_name_with_http(self, name, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_attribute_by_name_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/points/{webId}/attributes/{name}',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAPointAttribute',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
