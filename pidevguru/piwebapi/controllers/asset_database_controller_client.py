...
class AssetDatabaseControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/assetdatabases',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        response_type='PWAAssetDatabase',
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/assetdatabases/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, database, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, database, **kwargs)
        else:
            data = self.update_with_http(web_id, database, **kwargs)
            return data

    def update_with_http(self, web_id, database, **kwargs):
        all_params = list(['web_id', 'database'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def find_analyses(self, web_id, field, max_count=None, query=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.find_analyses_with_http(web_id, field, max_count, query, selected_fields, sort_field, sort_order, start_index, web_id_type, **kwargs)
        else:
            data = self.find_analyses_with_http(web_id, field, max_count, query, selected_fields, sort_field, sort_order, start_index, web_id_type, **kwargs)
            return data

    def find_analyses_with_http(self, web_id, field, max_count=None, query=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'field', 'max_count', 'query', 'selected_fields', 'sort_field', 'sort_order', 'start_index', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_analyses_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('field' not in params) or (params['field'] is None):
            raise ValueError("Missing the required parameter `field`")
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/analyses',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_analysis_categories(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_analysis_categories_with_http(web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_analysis_categories_with_http(web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_analysis_categories_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analysis_categories_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/analysiscategories',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def create_analysis_category(self, web_id, analysis_category, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_analysis_category_with_http(web_id, analysis_category, web_id_type, **kwargs)
        else:
            data = self.create_analysis_category_with_http(web_id, analysis_category, web_id_type, **kwargs)
            return data

    def create_analysis_category_with_http(self, web_id, analysis_category, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'analysis_category', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_analysis_category_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('analysis_category' not in params) or (params['analysis_category'] is None):
            raise ValueError("Missing the required parameter `analysis_category`")
    ...
    def get_analysis_templates(self, web_id, field, max_count=None, query=None, selected_fields=None, sort_field=None, sort_order=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_analysis_templates_with_http(web_id, field, max_count, query, selected_fields, sort_field, sort_order, web_id_type, **kwargs)
        else:
            data = self.get_analysis_templates_with_http(web_id, field, max_count, query, selected_fields, sort_field, sort_order, web_id_type, **kwargs)
            return data

    def get_analysis_templates_with_http(self, web_id, field, max_count=None, query=None, selected_fields=None, sort_field=None, sort_order=None, web_id_type=None, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analysis_templates_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/analysistemplates',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsAnalysisTemplate',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def create_analysis_template(self, web_id, template, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_analysis_template_with_http(web_id, template, web_id_type, **kwargs)
        else:
            data = self.create_analysis_template_with_http(web_id, template, web_id_type, **kwargs)
            return data

    def create_analysis_template_with_http(self, web_id, template, web_id_type=None, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_analysis_template_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_attribute_categories(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_attribute_categories_with_http(web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_attribute_categories_with_http(web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_attribute_categories_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_attribute_categories_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/attributecategories',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def create_attribute_category(self, web_id, attribute_category, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_attribute_category_with_http(web_id, attribute_category, web_id_type, **kwargs)
        else:
            data = self.create_attribute_category_with_http(web_id, attribute_category, web_id_type, **kwargs)
            return data

    def create_attribute_category_with_http(self, web_id, attribute_category, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'attribute_category', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_attribute_category_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('attribute_category' not in params) or (params['attribute_category'] is None):
            raise ValueError("Missing the required parameter `attribute_category`")
    ...
    def find_element_attributes(self, web_id, associations=None, attribute_category=None, attribute_description_filter=None, attribute_name_filter=None, attribute_type=None, element_category=None, element_description_filter=None, element_name_filter=None, element_template=None, element_type=None, max_count=None, search_full_hierarchy=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.find_element_attributes_with_http(web_id, associations, attribute_category, attribute_description_filter, attribute_name_filter, attribute_type, element_category, element_description_filter, element_name_filter, element_template, element_type, max_count, search_full_hierarchy, selected_fields, sort_field, sort_order, start_index, web_id_type, **kwargs)
        else:
            data = self.find_element_attributes_with_http(web_id, associations, attribute_category, attribute_description_filter, attribute_name_filter, attribute_type, element_category, element_description_filter, element_name_filter, element_template, element_type, max_count, search_full_hierarchy, selected_fields, sort_field, sort_order, start_index, web_id_type, **kwargs)
            return data

    def find_element_attributes_with_http(self, web_id, associations=None, attribute_category=None, attribute_description_filter=None, attribute_name_filter=None, attribute_type=None, element_category=None, element_description_filter=None, element_name_filter=None, element_template=None, element_type=None, max_count=None, search_full_hierarchy=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'associations', 'attribute_category', 'attribute_description_filter', 'attribute_name_filter', 'attribute_type', 'element_category', 'element_description_filter', 'element_name_filter', 'element_template', 'element_type', 'max_count', 'search_full_hierarchy', 'selected_fields', 'sort_field', 'sort_order', 'start_index', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_element_attributes_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/elementattributes',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_element_categories(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_element_categories_with_http(web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_element_categories_with_http(web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_element_categories_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_element_categories_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/elementcategories',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsElementCategory',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def create_element_category(self, web_id, element_category, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_element_category_with_http(web_id, element_category, web_id_type, **kwargs)
        else:
            data = self.create_element_category_with_http(web_id, element_category, web_id_type, **kwargs)
            return data

    def create_element_category_with_http(self, web_id, element_category, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'element_category', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_element_category_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_elements(self, web_id, associations=None, category_name=None, description_filter=None, element_type=None, max_count=None, name_filter=None, search_full_hierarchy=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, template_name=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_elements_with_http(web_id, associations, category_name, description_filter, element_type, max_count, name_filter, search_full_hierarchy, selected_fields, sort_field, sort_order, start_index, template_name, web_id_type, **kwargs)
        else:
            data = self.get_elements_with_http(web_id, associations, category_name, description_filter, element_type, max_count, name_filter, search_full_hierarchy, selected_fields, sort_field, sort_order, start_index, template_name, web_id_type, **kwargs)
            return data

    def get_elements_with_http(self, web_id, associations=None, category_name=None, description_filter=None, element_type=None, max_count=None, name_filter=None, search_full_hierarchy=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, template_name=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'associations', 'category_name', 'description_filter', 'element_type', 'max_count', 'name_filter', 'search_full_hierarchy', 'selected_fields', 'sort_field', 'sort_order', 'start_index', 'template_name', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_elements_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/elements',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def create_element(self, web_id, element, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_element_with_http(web_id, element, web_id_type, **kwargs)
        else:
            data = self.create_element_with_http(web_id, element, web_id_type, **kwargs)
            return data

    def create_element_with_http(self, web_id, element, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'element', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_element_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('element' not in params) or (params['element'] is None):
            raise ValueError("Missing the required parameter `element`")
    ...
    def get_element_templates(self, web_id, field, max_count=None, query=None, selected_fields=None, sort_field=None, sort_order=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_element_templates_with_http(web_id, field, max_count, query, selected_fields, sort_field, sort_order, web_id_type, **kwargs)
        else:
            data = self.get_element_templates_with_http(web_id, field, max_count, query, selected_fields, sort_field, sort_order, web_id_type, **kwargs)
            return data

    def get_element_templates_with_http(self, web_id, field, max_count=None, query=None, selected_fields=None, sort_field=None, sort_order=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'field', 'max_count', 'query', 'selected_fields', 'sort_field', 'sort_order', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_element_templates_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/elementtemplates',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsElementTemplate',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def create_element_template(self, web_id, template, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_element_template_with_http(web_id, template, web_id_type, **kwargs)
        else:
            data = self.create_element_template_with_http(web_id, template, web_id_type, **kwargs)
            return data

    def create_element_template_with_http(self, web_id, template, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'template', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_element_template_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_enumeration_sets_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/enumerationsets',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def find_event_frame_attributes(self, web_id, associations=None, attribute_category=None, attribute_description_filter=None, attribute_name_filter=None, attribute_type=None, end_time=None, event_frame_category=None, event_frame_description_filter=None, event_frame_name_filter=None, event_frame_template=None, max_count=None, referenced_element_name_filter=None, search_full_hierarchy=None, search_mode=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, start_time=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.find_event_frame_attributes_with_http(web_id, associations, attribute_category, attribute_description_filter, attribute_name_filter, attribute_type, end_time, event_frame_category, event_frame_description_filter, event_frame_name_filter, event_frame_template, max_count, referenced_element_name_filter, search_full_hierarchy, search_mode, selected_fields, sort_field, sort_order, start_index, start_time, web_id_type, **kwargs)
        else:
            data = self.find_event_frame_attributes_with_http(web_id, associations, attribute_category, attribute_description_filter, attribute_name_filter, attribute_type, end_time, event_frame_category, event_frame_description_filter, event_frame_name_filter, event_frame_template, max_count, referenced_element_name_filter, search_full_hierarchy, search_mode, selected_fields, sort_field, sort_order, start_index, start_time, web_id_type, **kwargs)
            return data

    def find_event_frame_attributes_with_http(self, web_id, associations=None, attribute_category=None, attribute_description_filter=None, attribute_name_filter=None, attribute_type=None, end_time=None, event_frame_category=None, event_frame_description_filter=None, event_frame_name_filter=None, event_frame_template=None, max_count=None, referenced_element_name_filter=None, search_full_hierarchy=None, search_mode=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, start_time=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'associations', 'attribute_category', 'attribute_description_filter', 'attribute_name_filter', 'attribute_type', 'end_time', 'event_frame_category', 'event_frame_description_filter', 'event_frame_name_filter', 'event_frame_template', 'max_count', 'referenced_element_name_filter', 'search_full_hierarchy', 'search_mode', 'selected_fields', 'sort_field', 'sort_order', 'start_index', 'start_time', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_event_frame_attributes_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/eventframeattributes',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_event_frames(self, web_id, can_be_acknowledged=None, category_name=None, end_time=None, is_acknowledged=None, max_count=None, name_filter=None, referenced_element_name_filter=None, referenced_element_template_name=None, search_full_hierarchy=None, search_mode=None, selected_fields=None, severity=None, sort_field=None, sort_order=None, start_index=None, start_time=None, template_name=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_event_frames_with_http(web_id, can_be_acknowledged, category_name, end_time, is_acknowledged, max_count, name_filter, referenced_element_name_filter, referenced_element_template_name, search_full_hierarchy, search_mode, selected_fields, severity, sort_field, sort_order, start_index, start_time, template_name, web_id_type, **kwargs)
        else:
            data = self.get_event_frames_with_http(web_id, can_be_acknowledged, category_name, end_time, is_acknowledged, max_count, name_filter, referenced_element_name_filter, referenced_element_template_name, search_full_hierarchy, search_mode, selected_fields, severity, sort_field, sort_order, start_index, start_time, template_name, web_id_type, **kwargs)
            return data

    def get_event_frames_with_http(self, web_id, can_be_acknowledged=None, category_name=None, end_time=None, is_acknowledged=None, max_count=None, name_filter=None, referenced_element_name_filter=None, referenced_element_template_name=None, search_full_hierarchy=None, search_mode=None, selected_fields=None, severity=None, sort_field=None, sort_order=None, start_index=None, start_time=None, template_name=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'can_be_acknowledged', 'category_name', 'end_time', 'is_acknowledged', 'max_count', 'name_filter', 'referenced_element_name_filter', 'referenced_element_template_name', 'search_full_hierarchy', 'search_mode', 'selected_fields', 'severity', 'sort_field', 'sort_order', 'start_index', 'start_time', 'template_name', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_event_frames_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/eventframes',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsEventFrame',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def create_event_frame(self, web_id, event_frame, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_event_frame_with_http(web_id, event_frame, web_id_type, **kwargs)
        else:
            data = self.create_event_frame_with_http(web_id, event_frame, web_id_type, **kwargs)
            return data

    def create_event_frame_with_http(self, web_id, event_frame, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'event_frame', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_event_frame_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('event_frame' not in params) or (params['event_frame'] is None):
            raise ValueError("Missing the required parameter `event_frame`")
    ...
    def export(self, web_id, end_time=None, export_mode=None, start_time=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.export_with_http(web_id, end_time, export_mode, start_time, **kwargs)
        else:
            data = self.export_with_http(web_id, end_time, export_mode, start_time, **kwargs)
            return data

    def export_with_http(self, web_id, end_time=None, export_mode=None, start_time=None, **kwargs):
        all_params = list(['web_id', 'end_time', 'export_mode', 'start_time'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method export_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/export',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def import_data(self, web_id, import_mode=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.import_data_with_http(web_id, import_mode, **kwargs)
        else:
            data = self.import_data_with_http(web_id, import_mode, **kwargs)
            return data

    def import_data_with_http(self, web_id, import_mode=None, **kwargs):
        all_params = list(['web_id', 'import_mode'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method import_data_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/import',
                                        'POST',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def remove_referenced_element(self, web_id, referenced_element_web_id, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.remove_referenced_element_with_http(web_id, referenced_element_web_id, **kwargs)
        else:
            data = self.remove_referenced_element_with_http(web_id, referenced_element_web_id, **kwargs)
            return data

    def remove_referenced_element_with_http(self, web_id, referenced_element_web_id, **kwargs):
        all_params = list(['web_id', 'referenced_element_web_id'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method remove_referenced_element_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('referenced_element_web_id' not in params) or (params['referenced_element_web_id'] is None):
            raise ValueError("Missing the required parameter `referenced_element_web_id`")
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/referencedelements',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_referenced_elements(self, web_id, associations=None, category_name=None, description_filter=None, element_type=None, max_count=None, name_filter=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, template_name=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_referenced_elements_with_http(web_id, associations, category_name, description_filter, element_type, max_count, name_filter, selected_fields, sort_field, sort_order, start_index, template_name, web_id_type, **kwargs)
        else:
            data = self.get_referenced_elements_with_http(web_id, associations, category_name, description_filter, element_type, max_count, name_filter, selected_fields, sort_field, sort_order, start_index, template_name, web_id_type, **kwargs)
            return data

    def get_referenced_elements_with_http(self, web_id, associations=None, category_name=None, description_filter=None, element_type=None, max_count=None, name_filter=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, template_name=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'associations', 'category_name', 'description_filter', 'element_type', 'max_count', 'name_filter', 'selected_fields', 'sort_field', 'sort_order', 'start_index', 'template_name', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_referenced_elements_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def add_referenced_element(self, web_id, referenced_element_web_id, reference_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_referenced_element_with_http(web_id, referenced_element_web_id, reference_type, **kwargs)
        else:
            data = self.add_referenced_element_with_http(web_id, referenced_element_web_id, reference_type, **kwargs)
            return data

    def add_referenced_element_with_http(self, web_id, referenced_element_web_id, reference_type=None, **kwargs):
        all_params = list(['web_id', 'referenced_element_web_id', 'reference_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_referenced_element_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_security_with_http(self, web_id, security_item, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, security_item=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_security_entry_with_http(self, name, web_id, apply_to_children=None, security_item=None, **kwargs):
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/securityentries/{name}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_table_categories(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_table_categories_with_http(web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_table_categories_with_http(web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_table_categories_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_table_categories_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/tablecategories',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsTableCategory',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def create_table_category(self, web_id, table_category, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_table_category_with_http(web_id, table_category, web_id_type, **kwargs)
        else:
            data = self.create_table_category_with_http(web_id, table_category, web_id_type, **kwargs)
            return data

    def create_table_category_with_http(self, web_id, table_category, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'table_category', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_table_category_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('table_category' not in params) or (params['table_category'] is None):
            raise ValueError("Missing the required parameter `table_category`")
    ...
    def get_tables(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_tables_with_http(web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_tables_with_http(web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_tables_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tables_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/assetdatabases/{webId}/tables',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def create_table(self, web_id, table, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_table_with_http(web_id, table, web_id_type, **kwargs)
        else:
            data = self.create_table_with_http(web_id, table, web_id_type, **kwargs)
            return data

    def create_table_with_http(self, web_id, table, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'table', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_table_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('table' not in params) or (params['table'] is None):
            raise ValueError("Missing the required parameter `table`")
