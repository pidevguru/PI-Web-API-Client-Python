...
class TimeRuleControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/timerules',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/timerules/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, time_rule, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, time_rule, **kwargs)
        else:
            data = self.update_with_http(web_id, time_rule, **kwargs)
            return data

    def update_with_http(self, web_id, time_rule, **kwargs):
        all_params = list(['web_id', 'time_rule'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('time_rule' not in params) or (params['time_rule'] is None):
            raise ValueError("Missing the required parameter `time_rule`")
