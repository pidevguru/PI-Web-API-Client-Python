...
class SecurityIdentityControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/securityidentities',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        response_type='PWASecurityIdentity',
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/securityidentities/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, security_identity, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, security_identity, **kwargs)
        else:
            data = self.update_with_http(web_id, security_identity, **kwargs)
            return data

    def update_with_http(self, web_id, security_identity, **kwargs):
        all_params = list(['web_id', 'security_identity'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_security_with_http(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/securityidentities/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/securityidentities/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entry_by_name_with_http(self, name, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/securityidentities/{webId}/securityentries/{name}',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_mappings(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_security_mappings_with_http(web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_security_mappings_with_http(web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_security_mappings_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        return self.api_client.call_api('/securityidentities/{webId}/securitymappings',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
