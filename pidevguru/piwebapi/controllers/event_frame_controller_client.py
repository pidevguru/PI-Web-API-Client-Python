...
class EventFrameControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_multiple(self, as_parallel=None, include_mode=None, path=None, selected_fields=None, web_id=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_multiple_with_http(as_parallel, include_mode, path, selected_fields, web_id, web_id_type, **kwargs)
        else:
            data = self.get_multiple_with_http(as_parallel, include_mode, path, selected_fields, web_id, web_id_type, **kwargs)
            return data

    def get_multiple_with_http(self, as_parallel=None, include_mode=None, path=None, selected_fields=None, web_id=None, web_id_type=None, **kwargs):
        all_params = list(['as_parallel', 'include_mode', 'path', 'selected_fields', 'web_id', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/eventframes/multiple',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsItemEventFrame',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_event_frames_query(self, database_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_event_frames_query_with_http(database_web_id, max_count, query, selected_fields, start_index, web_id_type, **kwargs)
        else:
            data = self.get_event_frames_query_with_http(database_web_id, max_count, query, selected_fields, start_index, web_id_type, **kwargs)
            return data

    def get_event_frames_query_with_http(self, database_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_event_frames_query_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/eventframes/search',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def create_search_by_attribute(self, query, no_results=None, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_search_by_attribute_with_http(query, no_results, selected_fields, web_id_type, **kwargs)
        else:
            data = self.create_search_by_attribute_with_http(query, no_results, selected_fields, web_id_type, **kwargs)
            return data

    def create_search_by_attribute_with_http(self, query, no_results=None, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['query', 'no_results', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/eventframes/searchbyattribute',
                                        'POST',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def execute_search_by_attribute(self, search_id, can_be_acknowledged=None, end_time=None, is_acknowledged=None, max_count=None, name_filter=None, referenced_element_name_filter=None, search_full_hierarchy=None, search_mode=None, selected_fields=None, severity=None, sort_field=None, sort_order=None, start_index=None, start_time=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.execute_search_by_attribute_with_http(search_id, can_be_acknowledged, end_time, is_acknowledged, max_count, name_filter, referenced_element_name_filter, search_full_hierarchy, search_mode, selected_fields, severity, sort_field, sort_order, start_index, start_time, web_id_type, **kwargs)
        else:
            data = self.execute_search_by_attribute_with_http(search_id, can_be_acknowledged, end_time, is_acknowledged, max_count, name_filter, referenced_element_name_filter, search_full_hierarchy, search_mode, selected_fields, severity, sort_field, sort_order, start_index, start_time, web_id_type, **kwargs)
            return data

    def execute_search_by_attribute_with_http(self, search_id, can_be_acknowledged=None, end_time=None, is_acknowledged=None, max_count=None, name_filter=None, referenced_element_name_filter=None, search_full_hierarchy=None, search_mode=None, selected_fields=None, severity=None, sort_field=None, sort_order=None, start_index=None, start_time=None, web_id_type=None, **kwargs):
        all_params = list(['search_id', 'can_be_acknowledged', 'end_time', 'is_acknowledged', 'max_count', 'name_filter', 'referenced_element_name_filter', 'search_full_hierarchy', 'search_mode', 'selected_fields', 'severity', 'sort_field', 'sort_order', 'start_index', 'start_time', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/eventframes/searchbyattribute/{searchId}',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, event_frame, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, event_frame, **kwargs)
        else:
            data = self.update_with_http(web_id, event_frame, **kwargs)
            return data

    def update_with_http(self, web_id, event_frame, **kwargs):
        all_params = list(['web_id', 'event_frame'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def acknowledge(self, web_id, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.acknowledge_with_http(web_id, **kwargs)
        else:
            data = self.acknowledge_with_http(web_id, **kwargs)
            return data

    def acknowledge_with_http(self, web_id, **kwargs):
        all_params = list(['web_id'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method acknowledge_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/eventframes/{webId}/acknowledge',
                                        'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_annotations(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_annotations_with_http(web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_annotations_with_http(web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_annotations_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_annotations_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/eventframes/{webId}/annotations',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsAnnotation',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def create_annotation(self, web_id, annotation, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_annotation_with_http(web_id, annotation, web_id_type, **kwargs)
        else:
            data = self.create_annotation_with_http(web_id, annotation, web_id_type, **kwargs)
            return data

    def create_annotation_with_http(self, web_id, annotation, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'annotation', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_annotation_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('annotation' not in params) or (params['annotation'] is None):
            raise ValueError("Missing the required parameter `annotation`")
    ...
    def delete_annotation(self, id, web_id, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_annotation_with_http(id, web_id, **kwargs)
        else:
            data = self.delete_annotation_with_http(id, web_id, **kwargs)
            return data

    def delete_annotation_with_http(self, id, web_id, **kwargs):
        all_params = list(['id', 'web_id'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_annotation_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/eventframes/{webId}/annotations/{id}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_annotation_by_id(self, id, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_annotation_by_id_with_http(id, web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_annotation_by_id_with_http(id, web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_annotation_by_id_with_http(self, id, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['id', 'web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_annotation_by_id_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def update_annotation(self, id, web_id, annotation, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_annotation_with_http(id, web_id, annotation, **kwargs)
        else:
            data = self.update_annotation_with_http(id, web_id, annotation, **kwargs)
            return data

    def update_annotation_with_http(self, id, web_id, annotation, **kwargs):
        all_params = list(['id', 'web_id', 'annotation'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_annotation_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def delete_annotation_attachment_media_by_id(self, id, web_id, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_annotation_attachment_media_by_id_with_http(id, web_id, **kwargs)
        else:
            data = self.delete_annotation_attachment_media_by_id_with_http(id, web_id, **kwargs)
            return data

    def delete_annotation_attachment_media_by_id_with_http(self, id, web_id, **kwargs):
        all_params = list(['id', 'web_id'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_annotation_attachment_media_by_id_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/eventframes/{webId}/annotations/{id}/attachment/media',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_annotation_attachment_media_metadata_by_id(self, id, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_annotation_attachment_media_metadata_by_id_with_http(id, web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_annotation_attachment_media_metadata_by_id_with_http(id, web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_annotation_attachment_media_metadata_by_id_with_http(self, id, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['id', 'web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_annotation_attachment_media_metadata_by_id_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/eventframes/{webId}/annotations/{id}/attachment/media/metadata',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAMediaMetadata',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_attributes_with_http(self, web_id, associations=None, category_name=None, max_count=None, name_filter=None, search_full_hierarchy=None, selected_fields=None, show_excluded=None, show_hidden=None, sort_field=None, sort_order=None, start_index=None, template_name=None, trait=None, trait_category=None, value_type=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/attributes',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def capture_values(self, web_id, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.capture_values_with_http(web_id, **kwargs)
        else:
            data = self.capture_values_with_http(web_id, **kwargs)
            return data

    def capture_values_with_http(self, web_id, **kwargs):
        all_params = list(['web_id'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method capture_values_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/eventframes/{webId}/attributes/capture',
                                        'POST',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_categories_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/categories',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def create_config_with_http(self, web_id, include_child_elements=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/config',
                                        'POST',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def find_event_frame_attributes_with_http(self, web_id, associations=None, attribute_category=None, attribute_description_filter=None, attribute_name_filter=None, attribute_type=None, end_time=None, event_frame_category=None, event_frame_description_filter=None, event_frame_name_filter=None, event_frame_template=None, max_count=None, referenced_element_name_filter=None, search_full_hierarchy=None, search_mode=None, selected_fields=None, sort_field=None, sort_order=None, start_index=None, start_time=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/eventframeattributes',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_event_frames_with_http(self, web_id, can_be_acknowledged=None, category_name=None, end_time=None, is_acknowledged=None, max_count=None, name_filter=None, referenced_element_name_filter=None, referenced_element_template_name=None, search_full_hierarchy=None, search_mode=None, selected_fields=None, severity=None, sort_field=None, sort_order=None, start_index=None, start_time=None, template_name=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/eventframes',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_referenced_elements(self, web_id, associations=None, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_referenced_elements_with_http(web_id, associations, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_referenced_elements_with_http(web_id, associations, selected_fields, web_id_type, **kwargs)
            return data

    def get_referenced_elements_with_http(self, web_id, associations=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/referencedelements',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_with_http(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_security_entry_with_http(self, name, web_id, apply_to_children=None, **kwargs):
        ...
        return self.api_client.call_api('/eventframes/{webId}/securityentries/{name}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
