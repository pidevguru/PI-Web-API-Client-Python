...
class NotificationContactTemplateControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationcontacttemplates',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        response_type='PWANotificationContactTemplate',
    ...
    def get_notification_contact_templates_query(self, asset_server_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_notification_contact_templates_query_with_http(asset_server_web_id, max_count, query, selected_fields, start_index, web_id_type, **kwargs)
        else:
            data = self.get_notification_contact_templates_query_with_http(asset_server_web_id, max_count, query, selected_fields, start_index, web_id_type, **kwargs)
            return data

    def get_notification_contact_templates_query_with_http(self, asset_server_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None, **kwargs):
        all_params = list(['asset_server_web_id', 'max_count', 'query', 'selected_fields', 'start_index', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_notification_contact_templates_query_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        body_params = None
        if 'asset_server_web_id' in params:
            if params['asset_server_web_id'] is not None:
                query_params['assetServerWebId'] = params['asset_server_web_id']
        ...
        return self.api_client.call_api('/notificationcontacttemplates/search',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/notificationcontacttemplates/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, notification_contact_template, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, notification_contact_template, **kwargs)
        else:
            data = self.update_with_http(web_id, notification_contact_template, **kwargs)
            return data

    def update_with_http(self, web_id, notification_contact_template, **kwargs):
        all_params = list(['web_id', 'notification_contact_template'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_notification_contact_templates_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationcontacttemplates/{webId}/notificationcontacttemplates',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_with_http(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationcontacttemplates/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationcontacttemplates/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_security_entry_with_http(self, name, web_id, apply_to_children=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationcontacttemplates/{webId}/securityentries/{name}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
