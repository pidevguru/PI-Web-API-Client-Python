...
class TableControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/tables',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/tables/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, table, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, table, **kwargs)
        else:
            data = self.update_with_http(web_id, table, **kwargs)
            return data

    def update_with_http(self, web_id, table, **kwargs):
        all_params = list(['web_id', 'table'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_categories_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/tables/{webId}/categories',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_data(self, web_id, selected_fields=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_data_with_http(web_id, selected_fields, **kwargs)
        else:
            data = self.get_data_with_http(web_id, selected_fields, **kwargs)
            return data

    def get_data_with_http(self, web_id, selected_fields=None, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_data_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/tables/{webId}/data',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update_data(self, web_id, data, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_data_with_http(web_id, data, **kwargs)
        else:
            data = self.update_data_with_http(web_id, data, **kwargs)
            return data

    def update_data_with_http(self, web_id, data, **kwargs):
        all_params = list(['web_id', 'data'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_data_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('data' not in params) or (params['data'] is None):
            raise ValueError("Missing the required parameter `data`")
    ...
    def get_security_with_http(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/tables/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/tables/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_security_entry_with_http(self, name, web_id, apply_to_children=None, **kwargs):
        ...
        return self.api_client.call_api('/tables/{webId}/securityentries/{name}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
