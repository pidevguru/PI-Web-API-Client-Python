...
class EnumerationSetControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/enumerationsets',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        response_type='PWAEnumerationSet',
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/enumerationsets/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, enumeration_set, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, enumeration_set, **kwargs)
        else:
            data = self.update_with_http(web_id, enumeration_set, **kwargs)
            return data

    def update_with_http(self, web_id, enumeration_set, **kwargs):
        all_params = list(['web_id', 'enumeration_set'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_values(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_values_with_http(web_id, selected_fields, web_id_type, **kwargs)
        else:
            data = self.get_values_with_http(web_id, selected_fields, web_id_type, **kwargs)
            return data

    def get_values_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'selected_fields', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        return self.api_client.call_api('/enumerationsets/{webId}/enumerationvalues',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PWAItemsEnumerationValue',
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def create_value(self, web_id, enumeration_value, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_value_with_http(web_id, enumeration_value, web_id_type, **kwargs)
        else:
            data = self.create_value_with_http(web_id, enumeration_value, web_id_type, **kwargs)
            return data

    def create_value_with_http(self, web_id, enumeration_value, web_id_type=None, **kwargs):
        all_params = list(['web_id', 'enumeration_value', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_value_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_security_with_http(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/enumerationsets/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/enumerationsets/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_security_entry_with_http(self, name, web_id, apply_to_children=None, **kwargs):
        ...
        return self.api_client.call_api('/enumerationsets/{webId}/securityentries/{name}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
