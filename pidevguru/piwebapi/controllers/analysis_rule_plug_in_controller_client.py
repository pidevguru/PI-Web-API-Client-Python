...
class AnalysisRulePlugInControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysisruleplugins',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        response_type='PWAAnalysisRulePlugIn',
    ...
    def get_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysisruleplugins/{webId}',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
