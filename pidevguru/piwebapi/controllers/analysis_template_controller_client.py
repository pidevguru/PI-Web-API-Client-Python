...
class AnalysisTemplateControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysistemplates',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        response_type='PWAAnalysisTemplate',
    ...
    def create_from_analysis(self, analysis_web_id, name=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_from_analysis_with_http(analysis_web_id, name, web_id_type, **kwargs)
        else:
            data = self.create_from_analysis_with_http(analysis_web_id, name, web_id_type, **kwargs)
            return data

    def create_from_analysis_with_http(self, analysis_web_id, name=None, web_id_type=None, **kwargs):
        all_params = list(['analysis_web_id', 'name', 'web_id_type'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_from_analysis_with_http" % key
                )
            params[key] = val
        del params['kwargs']

        if ('analysis_web_id' not in params) or (params['analysis_web_id'] is None):
            raise ValueError("Missing the required parameter `analysis_web_id`")
    ...
    def get_analysis_templates_query(self, database_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_analysis_templates_query_with_http(database_web_id, max_count, query, selected_fields, start_index, web_id_type, **kwargs)
        else:
            data = self.get_analysis_templates_query_with_http(database_web_id, max_count, query, selected_fields, start_index, web_id_type, **kwargs)
            return data

    def get_analysis_templates_query_with_http(self, database_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analysis_templates_query_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/analysistemplates/search',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/analysistemplates/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_categories_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysistemplates/{webId}/categories',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_with_http(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysistemplates/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/analysistemplates/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_security_entry_with_http(self, name, web_id, apply_to_children=None, **kwargs):
        ...
        return self.api_client.call_api('/analysistemplates/{webId}/securityentries/{name}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
