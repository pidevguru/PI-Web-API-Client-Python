...
class NotificationRuleControllerClient(object):
    ...
    def get_by_path_with_http(self, path, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationrules',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        ...
                                        response_type='PWANotificationRule',
    ...
    def get_notification_rules_query(self, database_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_notification_rules_query_with_http(database_web_id, max_count, query, selected_fields, start_index, web_id_type, **kwargs)
        else:
            data = self.get_notification_rules_query_with_http(database_web_id, max_count, query, selected_fields, start_index, web_id_type, **kwargs)
            return data

    def get_notification_rules_query_with_http(self, database_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_notification_rules_query_with_http" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/notificationrules/search',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_with_http(self, web_id, **kwargs):
        ...
        return self.api_client.call_api('/notificationrules/{webId}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def update(self, web_id, notification_rule, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_with_http(web_id, notification_rule, **kwargs)
        else:
            data = self.update_with_http(web_id, notification_rule, **kwargs)
            return data

    def update_with_http(self, web_id, notification_rule, **kwargs):
        all_params = list(['web_id', 'notification_rule'])
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_notification_rule_subscribers_with_http(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationrules/{webId}/notificationrulesubscribers',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def create_notification_rule_subscriber(self, web_id, notification_rule_subscriber, web_id_type=None, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_notification_rule_subscriber_with_http(web_id, notification_rule_subscriber, web_id_type, **kwargs)
        else:
            data = self.create_notification_rule_subscriber_with_http(web_id, notification_rule_subscriber, web_id_type, **kwargs)
            return data

    def create_notification_rule_subscriber_with_http(self, web_id, notification_rule_subscriber, web_id_type=None, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_notification_rule_subscriber_with_http" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_security_with_http(self, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationrules/{webId}/security',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def get_security_entries_with_http(self, web_id, name_filter=None, selected_fields=None, web_id_type=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationrules/{webId}/securityentries',
                                        'GET',
                                        path_params,
                                        query_params,
                                        header_params,
    ...
    def delete_security_entry_with_http(self, name, web_id, apply_to_children=None, **kwargs):
        ...
        return self.api_client.call_api('/notificationrules/{webId}/securityentries/{name}',
                                        'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
